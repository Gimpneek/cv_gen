...
urlpatterns = [
    ...
    url(r'^education/(?P<pk>[0-9]+)/$', views.EducationUpdateView.as_view(), name='education-edit'),
    url(r'^education/add/$', views.EducationCreateView.as_view(), name='education-new'),

    # Profile URLs
    url(r'^profiles/$', views.profiles_list, name='profiles_list'),
    url(r'^profile/(?P<pk>[0-9]+)/$', views.ProfileUpdateView.as_view(), name='profile-edit'),
    url(r'^profile/add/$', views.ProfileCreateView.as_view(), name='profile-new'),
